...
## Einleitung (vgl. [1-2,12-14,66-69])  
...
### BASE (vgl. [1-2,12-14,23,25,29-30])
...
### Clustering (vgl. [1-2,12-14,44-49])
...
### Replikation (vgl. [1-2,12-14,44-47,50-52])
...
### Sharding (vgl. [1-2,12-14,44-47,53-55])
...
### Hashing (vgl. [1-2,12,44-47,56-65])
...
## Map-Reduce (vgl. [1-2,12-14,31-43])
...
## In Memory Datenbanken (vgl. [8-11,14])
